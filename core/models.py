...
class SavedPosts(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='User', related_name='saved_posts')
    posts = models.ManyToManyField(to='Post', verbose_name='Saved Post', related_name='users_saved')
